...
The mean of the total number of steps taken per day is **`r mean_TotalStepsPerDay`**  
The median of the total number of steps taken per day is **`r median_TotalStepsPerDay`**
...
Number of Missing Values in the dataset is **`r NumberOfMissingValues`**.
...
```{r, echo = FALSE}
mean_TotalStepsPerDay2   <- toString(round(mean_TotalStepsPerDay2, digits = 2)) 
```

The means are  **`r mean_TotalStepsPerDay`** and **`r mean_TotalStepsPerDay2`**  
The medians are **`r median_TotalStepsPerDay`** and **`r median_TotalStepsPerDay2`**  
